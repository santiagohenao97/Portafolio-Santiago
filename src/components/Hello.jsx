    ...
    <div className="container-fluid text-light pb-5">
        <div className="row ">
            <div className="col-sm-6 ">
                ...
                <p className="lead ml-3">Electronic Engineer and EngD. Candidate at UPB<br/> My alter-ego is a Full Stack Developer and I love it…</p>
            ...
            <div className="col-sm-6 pt-3">
                ...
                <div className="tagline3b"><strong>var </strong>{'personalInfo= {'}</div>
                <br/>
                ...
                <div className="tagline3b"> <br/>{'}'}</div>
            </div>
        </div>
    </div>
</section>
